<template>
  <div ref="containerRef" class="v-scrollable" :class="{ hideArrows }">
    <button class="v-scrollable__left-button" icon="chevron-left" :class="{ disabled: left === 0 }" @click="scroll(-1)">
      <ChevronLeftIcon/>
    </button>
    ...
    <button class="v-scrollable__right-button" icon="chevron-right" :class="{ disabled: left >= maxLeft }" @click="scroll(1)">
      <ChevronRightIcon/>
    </button>
  </div>
</template>
